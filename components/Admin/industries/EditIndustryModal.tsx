    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0B192C]/40 backdrop-blur-xs animate-in fade-in duration-150">
            <div className="bg-white rounded-3xl w-full max-w-3xl max-h-[90vh] shadow-2xl border border-slate-200 flex flex-col">
                ...
                <div className="flex items-center bg-[#0B192C] rounded-3xl justify-between p-6 sm:p-8 pb-4 border-b border-slate-100 shrink-0">
                    <div>
                        <h2 className="text-lg font-bold text-white">Edit Industry</h2>
                        <p className="text-xs text-slate-500">Update industry details</p>
                    </div>
                    <button
                        onClick={onClose}
                        className="text-white hover:text-red-600 p-1.5 rounded-xl hover:bg-slate-100 transition-colors"
                    >
                        <X className="w-5 h-5" />
                    </button>
                </div>
                <div className="flex-1 overflow-y-auto p-6 sm:p-8 pt-4">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3.5 py-2.5 text-sm text-black bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0B192C]/10 focus:border-[#0B192C] transition-all"
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3.5 py-2 text-sm text-black bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0B192C]/10 focus:border-[#0B192C] transition-all"
                        ...
                        {/* Footer */}
                        <div className="pt-4 w-full border-t border-slate-200/60">
                            <div className="flex gap-3 items-center justify-end">
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="px-6 py-2.5 border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl text-sm font-semibold transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-[#0B192C] hover:bg-[#1E3E62] text-white rounded-xl text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[140px]"
                                >
