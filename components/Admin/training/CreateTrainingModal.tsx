// components/admin/training/CreateTrainingModal.tsx
'use client';
            ...
            <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] shadow-2xl border border-slate-200 flex flex-col">
                <div className="sticky top-0 z-10 bg-white rounded-t-3xl px-6 sm:px-8 pt-6 pb-4 border-b border-slate-100 shrink-0">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-xl font-bold tracking-tight text-slate-900">Create Training Program</h2>
                ...
                <div className="flex-1 overflow-y-auto px-6 sm:px-8 py-6">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-1.5">
                                    Icon <small>(Unicode Icons Need to use )</small>
                                </label>
                                <input
                                    type="text"
                                    value={formData.icon}
                        ...
                        {/* Footer */}
                        <div className="flex gap-3 pt-6 mt-4 justify-end">
                            <button
                                type="button"
                                onClick={onClose}
                            ...
                            <button
                                type="submit"
                                disabled={isSubmitting || isProcessing}
                                className="px-6 py-2.5 bg-[#0B192C] hover:bg-[#1E3E62] text-white rounded-xl text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[160px]"
                            >
                                {(isSubmitting || isProcessing) && (
                                    <Loader2 className="w-4 h-4 animate-spin" />
                                )}
                                {isSubmitting || isProcessing ? 'Processing...' : 'Create Training'}
                            </button>
                        </div>
                    </form>
                </div>
